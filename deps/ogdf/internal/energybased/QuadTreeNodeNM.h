...
namespace ogdf
{
    ...
    public:
        ...
        void get_I(List <QuadTreeNodeNM*> & l) const
        {
            l = I;
        }
        void get_D1(List <QuadTreeNodeNM*> & l) const
        {
            l = D1;
        }
        void get_D2(List <QuadTreeNodeNM*> & l) const
        {
            l = D2;
        }
        void get_M(List <QuadTreeNodeNM*> & l) const
        {
            l = M;
        }
